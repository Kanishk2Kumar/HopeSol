...
export function About() {
  return (
    <div className="m-10 mt-32">
      ...
      <div className="px-48">
        <p className="dark:text-white text-black text-xl leading-snug tracking-wide">HopeSol is a crowdfunding platform dedicated to empowering NGOs and connecting them with generous donors. Their mission is to create a transparent
        ...
        <p className="dark:text-white text-black text-xl leading-snug tracking-wide">With a focus on trust and transparency, HopeSol has implemented a thorough
