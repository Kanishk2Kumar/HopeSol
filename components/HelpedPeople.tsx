...
export function Helped() {
  ...
  return (
    <div className="h-[40rem] flex flex-col px-4 mt-20 lg:ml-48 bg-white">
      {/* Heading */}
      ...
      <div className="flex flex-col sm:flex-row mt-10 items-center sm:items-start gap-12 sm:gap-20 lg:gap-52">
        {/* Unordered List */}
