            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-none lg:w-[175px] flex flex-col gap-8">
                ...
                <Card className="bg-white border border-[#13ADB7] p-2 rounded-lg shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-center text-lg text-black">Funds Raised</CardTitle>
                  </CardHeader>
                ...
                <Card className="bg-white border border-[#13ADB7] p-2 rounded-lg shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-center text-lg text-black">Days Left</CardTitle>
                  </CardHeader>
            ...
            <div className="mt-8 flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-none lg:w-[350px]">
                <Card className="bg-white border border-[#13ADB7] p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardHeader>
                    <CardTitle className="text-center text-lg text-black">Fund This Campaign</CardTitle>
                  </CardHeader>
                  <CardContent>
